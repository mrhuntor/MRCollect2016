...
>- **2016/6/17 22:37** <del>每一个点的入度==出度【错误】</del>
...
>- **2016/6/17 22:37** <del>对于途中任意一点，流出该点的流一定等于流入的流【错误】</del>
...
>- **2016/6/17 21:07** <del>对于输入A，输出H，任意打乱数组A得到A’，输出H’的结果与H相同【不一定】</del>
>- **2016/6/17 22:37** <del>堆中最大值==h[0]【错误】</del>
...
>- **2016/6/17 22:37** <del>输入n1得到y1,输入k*n1，得到y2，k>=2,y1<=k*y2【重复】</del>
...
>- **2016/6/17 21:07** 输入为x 输出为s 若x为奇数 则s的最后一位为0 若x为偶数则s的最后一位为1
